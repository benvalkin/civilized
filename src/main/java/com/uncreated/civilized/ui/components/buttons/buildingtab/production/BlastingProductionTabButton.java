...
public class BlastingProductionTabButton extends BuildingTabButton {
   ...
   public BlastingProductionTabButton(ITabHost tabHost, int buttonTabIndex) {
      super(tabHost, buttonTabIndex, ICON, Tooltip.create(ProductionTypes.BLASTING.heading()));
   }
}
