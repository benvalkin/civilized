...
public class CraftingProductionTabButton extends BuildingTabButton {
   ...
   public CraftingProductionTabButton(ITabHost tabHost, int buttonTabIndex, Function<ITabHost, ATab> createTab) {
      super(tabHost, buttonTabIndex, ICON, Tooltip.create(ProductionTypes.CRAFTING.heading()), createTab);
   }
}
