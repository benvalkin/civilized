...
public class SmeltingProductionTabButton extends BuildingTabButton {
   ...
   public SmeltingProductionTabButton(ITabHost tabHost, int buttonTabIndex) {
      super(tabHost, buttonTabIndex, ICON, Tooltip.create(ProductionTypes.SMELTING.heading()));
   }
}
