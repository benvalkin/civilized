...
public class SmeltingProductionTabButton extends BuildingTabButton {
   ...
   public SmeltingProductionTabButton(ITabHost tabHost, int buttonTabIndex, Function<ITabHost, ATab> createTab) {
      super(tabHost, buttonTabIndex, ICON, Tooltip.create(ProductionTypes.SMELTING.heading()), createTab);
   }
}
