...
public class ButcheryBuildingScreen extends ABuildingMenuScreen {

   public ButcheryBuildingScreen(BuildingMenu menu, Inventory playerInventory, Component title) {
