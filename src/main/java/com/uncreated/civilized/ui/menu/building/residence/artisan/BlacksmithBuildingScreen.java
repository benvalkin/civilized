...
public class BlacksmithBuildingScreen extends ABuildingMenuScreen {

   public BlacksmithBuildingScreen(BuildingMenu menu, Inventory playerInventory, Component title) {
