...
public abstract class ALazyLoadBuildingScreenTab extends ATabWithViewableItemSlots {

   private final Component tabTitle;
   protected final BuildingScreenContext context;

   public ALazyLoadBuildingScreenTab(
         ILazyLoadTabHost tabHost,
         Font font,
         Component tabTitle,
         BuildingScreenContext context) {
      super(
            0 /* todo: we don't need tab indexes anymore */,
            tabHost.getTabCoords().contentLeftPos(),
            tabHost.getTabCoords().contentTopPos(),
            tabHost.getTabCoords().tabWidth(),
            tabHost.getTabCoords().tabHeight(),
            font);
